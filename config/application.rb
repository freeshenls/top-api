...
module TopApi
  class Application < Rails::Application
    ...
    config.active_record.schema_migrations_table_name = "top_api.schema_migrations"
    config.active_record.internal_metadata_table_name = "top_api.ar_internal_metadata"
